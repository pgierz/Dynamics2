  ...
  sidebarPanel(id="sidebar",
    ...
    accordionsetPanel(id="Parameter_accordion", 
                      accordionPanel(collapsed=TRUE,
                                     head="heat capacity and heat fluxes", 
                      ...
                      accordionPanel(collapsed=TRUE,
                                     head=HTML("solar CO<sub>2</sub> effect"),
                      ...
                      accordionPanel(collapsed=TRUE,
                                     head="additional fresh water fluxes", 
          ...
          Row(Span(class=c(4, "well"),
                   Span(class=c(12, "alert alert-warning"),
                        radioButtons(inputId="initialCondType", 
                                ...
                                choices=c("initial conditions from Spin-Up run"="spinUp",
                                          "default initial conditions"="default"))), 
                   p(),
