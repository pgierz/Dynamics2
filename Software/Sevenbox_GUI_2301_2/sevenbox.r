Out=sevenbox <-function(flag='S',       # Set flag=S,M,N,D to perturb resp. the south, middle lat, north, deep box
                        ...
                        Ks=2.5e13,      # Set sensible heat flux
                        Kl=7.65e17,     # Set latent heat flux
                        CFnl=1,
...
#   Tasl0_i = Initial$Tasl
# else
#   Tasl0_i = 0.456563E+01; 
# 
# if (!is.null(Initial$Taml))
#   Taml0_i = Initial$Taml
# else
#   Taml0_i = 0.232326E+02;
# 
# if (!is.null(Initial$Tanl))
#   Tanl0_i = Initial$Tanl
# else
#   Tanl0_i = 0.141447E+01;
# 
# if (!is.null(Initial$Tsl))
#   Tsl0_i = Initial$Tsl
# else
...
# if (flag == 'S') ## Hosing south
#   {
#   Ssl0_i = 0.344010E+02;
#   cat('South \n')
#   }
# else if (flag == 'M') ## Hosing middle lat
#   {
#   Sml0_i = 0.359102E+02;
#   cat('ML \n')
#   }
# else if (flag == 'N') ## Hosing north
#   {
#   Snl0_i = 0.349113E+02;
#   cat('North \n')
#   }
# else if (flag == 'D') ## Hosing deep
#   {
#   Sd0_i = 0.349113E+02;   
#   cat('Deep \n')
#   }
...
Q1nl = 20.;
Q1ml = 70.;
Q1sl = 10.;#tuning parameters for surface heat fluxes
Q2nl = 50.;
Q2ml = 50.;
Q2sl = 50.;
...
for (j in 1:N_pert){
    ...
    for (i in 1:jend){
        ...
        if(phi > 0.){
          ...
          Smln = Sml + dts * (-(Sml-Snl)*phi/Vml+Sref*FWFAN/Vml+Sref*FWFAS/Vml);
